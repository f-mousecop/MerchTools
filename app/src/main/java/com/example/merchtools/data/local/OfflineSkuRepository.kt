...
import com.example.merchtools.data.local.repository.SkuRepository
...
class OfflineSkuRepository(val skuDao: SkuDao) : SkuRepository {
    ...
    override fun searchSkus(query: String): Flow<List<Sku>> {
